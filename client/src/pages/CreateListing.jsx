    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                maxLength={62} minLength={10} className='border p-3 rounded-lg' required/>
            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className="flex gap-4">
                    ...
                    <button disabled={uploading} type="button" onClick={handleImageSubmit} className="p-3 text-green-700 border
                     uppercase hover:shadow-lg disabled:ocpacity-80 border-green-700">
                        {uploading ? 'Uploading': 'Uplaod' }
                     </button>
                </div>
